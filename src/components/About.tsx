    ...
    <section id="about">
      <div className="container about-container">
        <div className='about'>
          ...
          <p>After creating a few of my own apps and getting involved in some brilliant opportunities as a developer with <a style={{ color: '#1010ff' }} target="_blank" href="https://momentone.io/">Moment One</a> and <a style={{ color: '#1010ff' }} target="_blank" href="https://www.womenwhocode.com/tokyo">Women Who Code Tokyo</a>, I knew I&apos;d found my place. I joined <a style={{ color: '#1010ff' }} target="_blank" href="https://generalassemb.ly/education/software-engineering-immersive/london">General Assembly</a>&apos;s Software Engineering Immersive to advance my skills to a professional level and ensure I will add value in the workplace.</p>
